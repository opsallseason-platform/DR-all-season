            ...
            <div className="text-center">
              ...
              <div className="bg-blue-50 rounded-lg p-4 text-left mb-8">
                ...
                <ul className="list-disc pl-5 space-y-1 text-blue-700">
                  ...
                  <li>Our team will contact you via phone, email, or WhatsApp 24 hours before the service</li>
                ...
                <p className="text-blue-600 text-sm mt-3">
                  ...
                  <a href="/en/privacy-policy" className="underline hover:text-blue-800">Privacy Policy</a>.
                </p>
              </div>
