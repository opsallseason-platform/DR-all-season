              ...
              <CardContent className="p-6">
                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                  <p className="text-xs text-slate-gray italic">
                    ⚠️ SUVs and sedans are available upon request only. Promotional rates do not apply to SUV vehicles.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <div className="mb-6">
                <div className="flex items-baseline mb-2">
                  {service.originalPrice && (
                    <span className="text-2xl font-bold text-slate-gray line-through mr-2">${service.originalPrice}</span>
                  )}
                  <span className="text-4xl font-bold text-caribbean-teal">${service.price}</span>
                  <span className="text-slate-gray ml-2">USD</span>
                </div>
                {service.originalPrice && (
                  <p className="text-xs font-semibold text-green-600 mb-2 uppercase tracking-wider">
                    🎉 Promo Price!
                  </p>
                )}
                ...
                {extraPersonPrice && (
                  <p className="text-sm text-slate-gray">
                    +${extraPersonPrice} per extra passenger (5+)
                  </p>
                )}
              </div>
