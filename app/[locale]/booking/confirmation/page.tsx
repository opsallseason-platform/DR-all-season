          ...
          <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-8">
            <div className="text-center">
              ...
              <div className="bg-gray-50 rounded-lg p-6 text-left mb-8">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between pt-3 border-t border-gray-200">
                    <span className="text-gray-900 font-semibold">{t('totalAmount')}</span>
              ...
              <div className="bg-yellow-50 rounded-lg p-4 text-left mb-8">
                <h3 className="font-medium text-yellow-800 mb-2">{t('nextStep')}</h3>
                <p className="text-yellow-700">
                  {t('confirmationNote')}
                </p>
                <p className="text-yellow-600 text-sm mt-3">
                  {t('privacyConsent')}{' '}
                  <a href="/en/privacy-policy" className="underline hover:text-yellow-800">{t('privacyLink')}</a>.
                </p>
              </div>
