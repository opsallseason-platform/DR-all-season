    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-black">
        ...
        <div className="min-h-screen flex items-center justify-center">
          <p className="text-white/70 font-light tracking-wide">Loading...</p>
        </div>
        <Footer />
      </div>
    );
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-black">
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-2xl font-light text-white mb-4 tracking-wide">No Service Selected</h1>
            <p className="text-white/70 mb-6 font-light">Please select a service to book.</p>
            <Button onClick={() => window.location.href = '/tours'} className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white px-8 py-4 rounded-2xl font-normal tracking-wide">Browse Services</Button>
          </div>
        </div>
        <Footer />
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {step === 1 && (
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-8">
              <h2 className="text-2xl font-light mb-6 text-white tracking-wide">Booking Details</h2>
          ...
          {step === 2 && (
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-8">
              <div className="text-center py-12">
                ...
                <h2 className="text-3xl font-light text-white mb-3 tracking-wide">Booking Submitted!</h2>
                ...
                {bookingReference && (
                  <div className="mb-6">
                    <p className="text-white/50 text-sm font-light uppercase tracking-wider mb-1">Booking Reference</p>
                ...
                <div className="bg-gradient-to-br from-blue-900/20 to-blue-800/10 border border-blue-500/20 rounded-2xl p-6 text-left max-w-md mx-auto mb-8">
                  <h3 className="font-normal text-white mb-4 tracking-wide">Booking Summary</h3>
                  <p className="text-white/70 font-light mb-2"><span className="font-normal text-white">Service:</span> {service.title}</p>
                  <p className="text-white/70 font-light mb-2"><span className="font-normal text-white">Date:</span> {selectedDate ? selectedDate.toLocaleDateString() : ''}</p>
                  <p className="text-white/70 font-light mb-2"><span className="font-normal text-white">Time:</span> {selectedTime}</p>
                  ...
                  <p className="text-white/70 font-light mb-2"><span className="font-normal text-white">Passengers:</span> {totalPassengers}</p>
                  <p className="text-white font-light mt-4 pt-4 border-t border-white/20"><span className="font-normal">Total:</span> <span className="text-blue-400">${totalPrice.toFixed(2)}</span></p>
                </div>
                ...
                <div className="bg-gradient-to-br from-amber-900/20 to-amber-800/10 border border-amber-500/20 rounded-2xl p-4 max-w-md mx-auto mb-8">
                  <p className="text-amber-200/80 font-light text-sm">
                    Our team will reach out to you via email or WhatsApp within 24 hours to confirm your reservation and provide payment instructions.
                  </p>
                </div>
